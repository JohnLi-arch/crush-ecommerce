package com.john.crush.user;

import javax.validation.constraints.NotEmpty;
import javax.validation.constraints.NotNull;
import javax.validation.constraints.Size;

import com.john.crush.validator.FieldMatch;
import com.john.crush.validator.ValidEmail;
...
public class CrmUser {
	...
	public String toString() {
		return "CrmUser{" + "username='" + username + '\'' + ", password='" + password + '\'' + ", matchingPassword='"
